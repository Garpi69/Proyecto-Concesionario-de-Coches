...
public class VentanaAñadirVenta extends JFrame {
    ...
    public VentanaAñadirVenta(DAO dao) {
        ...
        botonAgregar.addActionListener(e -> {
        	Venta venta = new Venta(campoCategoria.getText(),Integer.parseInt(campoIdVehiculo.getText()),campoMarca.getText(),campoModelo.getText(),Integer.parseInt(campoPrecioVenta.getText()),campoDniComprador.getText());
