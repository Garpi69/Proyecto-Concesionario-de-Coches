...
public class VentanaAñadirCoche extends JFrame {
	    ...
	    public VentanaAñadirCoche(DAO dao) {
	        ...
	        botonGuardar.addActionListener(e -> {
	        	...
	        	Coche coche = new Coche (Integer.parseInt(campoID.getText()),campoCombustible.getText(),campoMarca.getText(),campoModelo.getText(),campoColor.getText(),campoTipo.getText(),Integer.parseInt(campoPotencia.getText()),Integer.parseInt(campoNumPlazas.getText()),Integer.parseInt(campoPrecio.getText()),Integer.parseInt(campoCuota.getText()),matriculacion,"","concesionario");
	        	try {
