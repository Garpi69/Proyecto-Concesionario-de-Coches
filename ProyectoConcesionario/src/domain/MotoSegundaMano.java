...
public class MotoSegundaMano extends Moto implements SegundaMano {
	...
	public MotoSegundaMano(int idVehiculo, String combustible, String marca, String modelo, String color, String tipo,
			int potencia, int numPlazas, int precio, int cuota, Date matriculacion, int peso, boolean baul,
			int kilometraje, String ofertas, String propietario) {
		super(idVehiculo, combustible, marca, modelo, color, tipo, potencia, numPlazas, precio, cuota, matriculacion,
				peso, baul, ofertas, propietario);
		this.kilometraje = kilometraje;
	}
