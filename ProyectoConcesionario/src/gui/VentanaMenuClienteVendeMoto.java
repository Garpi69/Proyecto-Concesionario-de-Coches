...
public class VentanaMenuClienteVendeMoto extends JFrame {
	...
	public VentanaMenuClienteVendeMoto(DAO dao) {
		...
		enviarButton.addActionListener(e -> {
			try {
				...
				String loginCliente = dao.cliente.getLogin();
				Cliente cliente = dao.obtenerClientePorLogin(loginCliente);
				MotoSegundaMano moto = new MotoSegundaMano(idVehiculo, combustible, marca, modelo, color, tipo,
						potencia, numPlazas, precio, cuota, matriculacion, kilometraje, baul, peso, null,
						cliente.getDni());
