...
public class VentanaMenuClienteVendeCoche extends JFrame {
	...
	public VentanaMenuClienteVendeCoche(DAO dao) {
		...
		enviarButton.addActionListener(e -> {
			try {
				CocheSegundaMano cocheSegundaMano = obtenerCocheSegundaMano(dao);
	...
	public CocheSegundaMano obtenerCocheSegundaMano(DAO dao) throws SQLException {
		...
		CocheSegundaMano cocheSegundaMano = new CocheSegundaMano(idVehiculo, combustible, marca, modelo, color, tipo,
				potencia, numPlazas, precio, cuota, matriculacion, kilometraje, null, dao.cliente.getLogin());
